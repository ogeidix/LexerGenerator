...
public class Lexer {
    ...
    public static final int
        TOKEN_EOF = 0 , TOKEN_BOMB_LIT=1 , TOKEN_FALSE_LIT=2 , TOKEN_BOOLEAN_LIT=3 , TOKEN_BOSNSA_LIT=4 , TOKEN_HELLO_LIT=5 ;

    private static final String[] tokenImage = {
            "<EOF>" , "<BOMB_LIT>" , "<FALSE_LIT>" , "<BOOLEAN_LIT>" , "<BOSNSA_LIT>" , "<HELLO_LIT>" 
          };
    ...
    public int next() throws LexerException, IOException{
...
if (currentChar=='n'){
readNext();
return Lexer.TOKEN_BOOLEAN_LIT;
}
parseError(Lexer.TOKEN_BOOLEAN_LIT);
}
parseError(Lexer.TOKEN_BOOLEAN_LIT);
}
parseError(Lexer.TOKEN_BOOLEAN_LIT);
...
if (currentChar=='b'){
readNext();
return Lexer.TOKEN_BOMB_LIT;
}
parseError(Lexer.TOKEN_BOMB_LIT);
break;case 'n':
readNext();
if (currentChar=='s'){
readNext();
...
if (currentChar=='i'){
readNext();
return Lexer.TOKEN_BOSNSA_LIT;
}
parseError(Lexer.TOKEN_BOSNSA_LIT);
}
parseError(Lexer.TOKEN_BOSNSA_LIT);
}
parseError(Lexer.TOKEN_BOSNSA_LIT);
break;}parseError(Lexer.TOKEN_BOMB_LIT,Lexer.TOKEN_BOSNSA_LIT,Lexer.TOKEN_BOOLEAN_LIT);
}
parseError(Lexer.TOKEN_BOMB_LIT,Lexer.TOKEN_BOSNSA_LIT,Lexer.TOKEN_BOOLEAN_LIT);
break;case 'f':
readNext();
if (currentChar=='a'){
readNext();
...
if (currentChar=='e'){
readNext();
return Lexer.TOKEN_FALSE_LIT;
}
parseError(Lexer.TOKEN_FALSE_LIT);
}
parseError(Lexer.TOKEN_FALSE_LIT);
}
parseError(Lexer.TOKEN_FALSE_LIT);
...
if (currentChar=='o'){
readNext();
return Lexer.TOKEN_HELLO_LIT;
}
parseError(Lexer.TOKEN_HELLO_LIT);
}
parseError(Lexer.TOKEN_HELLO_LIT);
}
parseError(Lexer.TOKEN_HELLO_LIT);
...
parseError(Lexer.TOKEN_HELLO_LIT);
break;}parseError(Lexer.TOKEN_BOMB_LIT,Lexer.TOKEN_FALSE_LIT,Lexer.TOKEN_BOSNSA_LIT,Lexer.TOKEN_HELLO_LIT,Lexer.TOKEN_BOOLEAN_LIT);
...
// ================================================================================
    ...
    public Lexer(java.io.Reader stream) throws IOException{
        reInit(stream);
    }
    ...
    public String tokenKindToString(int token) {
...
// ================================================================================    
    ...
    protected int parseError(String reason) throws LexerException {
        throw new LexerException(reason);
    }
    
    protected int parseError(int ... numbers) throws LexerException {
        throw new LexerException(numbers.toString());
    }
